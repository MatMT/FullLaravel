<div class="px-4 xl:px-0">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto">
            <h3 class="font-extra-bold text-4xl text-gray-800 mb-12">Nuestras Vacantes</h3>
            <div class=" bg-white shadow-sm rounded-lg p-6 divide-y divide-gray-200">
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            <a href="{{ route('vacantes.show', $vacante->id) }}" class="text-2xl font-bold text-gray-600">
                                {{ $vacante->titulo }}
                            </a>
                        ...
                        <div class="mt-5 md:mt-0">
                            <a href="{{ route('vacantes.show', $vacante->id) }}"
                                class=" bg-indigo-500 p-3 text-sm font-bold text-white rounded-lg block text-center ">
                                Ver Vacante
                            </a>
                        </div>
                    </div>
