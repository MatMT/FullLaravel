...
@section('contenido')
    <div class="md:flex md:justify-center md:gap-10 md:items-center" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow">
            <form method="POST" action="{{route('login')}}" novalidate>
                ...
                <div class="mb-5">
                    <input type="checkbox" name="remember"> <span class="text-gray-500 text-sm">Mantener mi sesión abierta</span>
                </div>
